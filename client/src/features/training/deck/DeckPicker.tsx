...
function DeckPicker({ deck }: DeckProps) {
  ...
  return (
    <div
      className={`flex size-80 animate-pop flex-col items-center justify-between rounded-md ${cards.length > 0 ? "bg-tertiary" : "bg-stripes-diag-reverse"} ${showImage ? "justify-between bg-[url('/images/deck.png')] bg-cover" : ""} pt-3 shadow-custom-light sm:size-60`}
    >
      <h3
        ref={ref}
