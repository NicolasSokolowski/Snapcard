...
function Footer() {
  ...
  return (
    ...
    >
      ...
      <div className="mx-10 flex w-full items-center justify-between gap-8 font-patua text-xs text-textPrimary sm:mx-20 sm:justify-between sm:gap-0 sm:text-base lg:text-lg">
